...
//    bool is_double_spent(chain::transaction const& tx) const;
    ...
    code transaction_check_sequential(transaction_const_ptr tx) const;
    ...
    code transaction_validate_sequential(transaction_const_ptr tx) const;
    code transaction_validate_sequential_no_signature(transaction_const_ptr tx) const;

    code transaction_check_v2_sequential(chainv2::transaction::const_ptr tx) const;
    code transaction_accept_v2_sequential(chainv2::transaction::const_ptr tx) const;
    code transaction_connect_v2_sequential(chainv2::transaction::const_ptr tx) const;
    code transaction_validate_v2_sequential(chainv2::transaction::const_ptr tx) const;
    code transaction_validate_v2_sequential_no_signature(chainv2::transaction::const_ptr tx) const;
