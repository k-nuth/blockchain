...
struct state_delegated {
    ...
    using create_asset_func = std::function<void(std::string /*asset_name*/, amount_t /*asset_amount*/, bc::wallet::payment_address const& /*owner*/, size_t /*block_height*/, kth::hash_digest const& /*txid*/)>;
    using create_balance_entry_func = std::function<void(asset_id_t /*asset_id*/, amount_t /*asset_amount*/, bc::wallet::payment_address const& /*source*/, bc::wallet::payment_address const& /*target*/, size_t /*block_height*/, kth::hash_digest const& /*txid*/)>;
